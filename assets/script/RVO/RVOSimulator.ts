...
// export default class RVOSimulator {
...
//   addAgentDefault(position: Vector2D = null) {
...
//   addAgent(position: Vector2D, radius: number, velocity: Vector2D, maxSpeed: number, neighborDist: number) {
//     var agent = new Agent();
