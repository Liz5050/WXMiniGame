...
export class ObjectPool {
    ...
    public static pop(refKey:string, ...args:any[]):any {
        ...
        if (list.length) {
            ...
            var classZ:any = js.getClassByName(refKey);
    ...
    public static push(obj:any):boolean {
        ...
        // if(refKey == "GLoader") {
        //     if(obj.x != 0 || obj.y != 0 || obj.alpha != 1 || obj.width != 0 || obj.height != 0) {
        //         console.log("GLoader回池,属性没有重置x:",obj.x,"y:",obj.y,"alpha:",obj.alpha,"width:",obj.width,"height:",obj.height);
        //     }
        // }
